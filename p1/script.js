$(document).ready(function() {
    ...
    $('.content').on('click', '.beginBtn', function() {
        ...
        if (container.attr('id') === 'textContainer2') {
            var $newText = $('<p>Not every poem is finished—one poem is abandoned, another catches fire and is carried away by the wind, which may be an ending, but it is the ending of a poem without an end.</p><br><p><a href="../home.html">[ abandon poem? ]</a></p>');
